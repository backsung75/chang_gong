...
#define _DUTY_MIN 900   // Servo angle: E degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 607.0 + -1.23*a_value + -4.8E-03*a_value*a_value + 1.66E-05*a_value*a_value*a_value + -1.32E-08*a_value*a_value*a_value*a_value;
}
