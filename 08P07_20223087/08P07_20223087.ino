...
void loop() {
  ...
  if (distance < _DIST_MIN - 10 || distance > _DIST_MAX + 10){
    ...
    analogWrite(PIN_LED, (1 - ((distance - 100) / 100))*255);       // LED ON      
  } else {
    analogWrite(PIN_LED, ((distance - 200) / 100) * 255);
  }
  ...
  // do something here
  // delay(100); // Assume that it takes 50ms to do something.
